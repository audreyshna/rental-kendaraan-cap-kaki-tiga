...
class FormTransaksi extends BaseController
{
    public function index($id_kendaraan)
    {
        ...
        if (!$kendaraan) {
            return redirect()->to(base_url('admin/home'))->with('error', 'Data kendaraan tidak ditemukan.');
        }

        return view('admin/formTransaksi', ['kendaraan' => $kendaraan]);
    }
    ...
    public function formTransaksi($id_kendaraan)
    {
        ...
        $validationRules = [
            ...
            'no_telp' => 'required',
            'alamat' => 'required',
            'tanggal-sewa' => 'required|valid_date',
            'tanggal-kembali' => 'required|valid_date',
            'pembayaran' => 'required',
        ...
        $penyewaData['nama'] = trim(strtolower($penyewaData['nama']));
        $penyewaData['alamat'] = trim(strtolower($penyewaData['alamat']));
        $penyewaData['no_telp'] = trim($penyewaData['no_telp']);
        $penyewaData['no_ktp'] = trim($penyewaData['no_ktp']);

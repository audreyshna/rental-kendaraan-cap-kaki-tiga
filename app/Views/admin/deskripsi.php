...
<html>
    ...
    <body>
        ...
        <section id="pilih-kendaraan">
            <div class="link">
                <a href="<?= base_url('admin/home') ?>">Home</a> >> <a href="<?= base_url('admin/' . ($kendaraan['tipe'] === 'Mobil' ? 'listMobil' : 'listMotor')) ?>"><?= ucfirst($kendaraan['tipe']) ?></a> >><a href="<?= current_url() ?>"><?= $kendaraan['merk'] ?></a>
            </div>
            <div class="container">
            ...
            <div class="btn">
                ...
                <?php else: ?>
                    <button class="btn-sewa" onclick="window.location.href='<?= base_url('admin/formTransaksi/' . $kendaraan['id_kendaraan']) ?>'">Sewa</button>
                <?php endif; ?>
            </div>
        </section>
    </body>

...
<body>
  ...
  <main>
    <section id="pilih-kendaraan">
        <div class="link">
            <a href="<?= base_url('users/home') ?>">Home</a> >> <a href = "<?= base_url('users/listMobil') ?>">Mobil</a>
        </div>
    </section>
    <h1>Mobil</h1>
    <div class="search-bar">
      ...
      <?php foreach($kendaraan as $mobil): ?>
        <a href="<?= base_url('users/deskripsi/'.$mobil['id_kendaraan']) ?>" class="car-card" data-name="<?= strtolower($mobil['merk']) ?>">

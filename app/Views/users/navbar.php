...
<html>
    ...
    <nav>
            ...
            <ul class="nav-links hidden">
                <li class="nav-link"><a href="<?= base_url('users/home') ?>">Home</a></li>
                <li class="nav-link dropdown-toggle"><a href="<?= base_url('users/listMobil') ?>">Kategori</a>
                    <i id="dropdown-Arrow" class="ph ph-caret-down"></i>
                    <ul class="dropdown-fullscreen services">
                        <li><a href="#" data-href="<?= base_url('users/listMobil') ?>">Mobil</a></li>
                        <li><a href="#" data-href="<?= base_url('users/listMotor') ?>">Motor</a></li>
                    </ul>
                </li>
                <li class="nav-link"><a href="<?= base_url('auth/logout') ?>">Log Out</a></li>
                <li class="nav-link"><a href="<?= base_url('users/contact') ?>">Contact</a></li>
            </ul>
            <div id="dropdown-Menu" class="dropdown-menu open">
                <li><a href="<?= base_url('users/home') ?>">Home</a></li>
                <li class="dropdown-toggle-responsive">
                    <a href="<?= base_url('users/home') ?>">Kategori</a>
                ...
                <li><a href="<?= base_url('users/contact') ?>">Contact</a></li>
            </div>
        </nav>

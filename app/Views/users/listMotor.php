...
<body>
  ...
  <main>
    <section id="pilih-kendaraan">
        <div class="link">
            <a href="<?= base_url('users/home') ?>">Home</a> >> <a href="<?= base_url('users/listMotor') ?>"> Motor </a>
        </div>
    </section>
    <h1>Motor</h1>
    <div class="search-bar">
      ...
      <?php foreach ($kendaraan as $motor): ?>
          <a href="<?= base_url('users/deskripsi/'.$motor['id_kendaraan']) ?>" class="car-card" data-name="<?= strtolower($motor['merk']) ?>">
